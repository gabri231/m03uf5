...
public class exercici81 {
	public static void main(String[] args) {
		...
		// Se a�aden dos valores al objeto en la primera y segunda posici�n.
		array.add(0,0);
		array.add(1,1);
		
		// El atributo 'cantidad' de tipo Int, es utilizado como referencia para para determinar el tama�o del objeto 'array' de la clase ArrayList 
		int cantidad=25;
		...
		// Se imprime la posici�n del valor 2584
		// El metodo para ubicar la posici�n de un valor es:   .indexOf(valor);
		System.out.println("\n--------------------------------------------------------------------------------------------");
