...
public class Exercici89 {
	...
	public static void main(String[] args) {
		...
		Metodos.eliminarCoche(cilindrada, mapaDeCoches);
		...
		int cilindros = 4;
		arrayDeCochesPorCilindro = Metodos.mapDeCochesPorCilindro(cilindros,mapaDeCoches);
		...
		mapDeCochesOrdMarca = Metodos.mapCochesPorMarca(mapaDeCoches);
